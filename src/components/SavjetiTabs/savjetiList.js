export const savjetiList = [
  {
    pitanje: "Koja je razlika između botox i filera?",
    odgovor:
      "Botox je najbolji izbor kod uklanjanja dinamickih bora i djeluje tako da smanjuje mišićnu aktivnost i tako doprinosi pomlađenom izgledu. Može se koristiti i kao terapija hiperhidroze. Filere koristimo kad želimo vratiti izgubljeni volumen i zagladiti kožu uslijed dehidracije.",
  },
  {
    pitanje: "Kolika je trajnost filera?",
    odgovor:
      "Trajnost ovisi o mnogim faktorima ali općenito možemo reći da je učinak vidljiv do 9 mjeseci, ponekad i više od godine dana.",
  },
  {
    pitanje:
  ...
  },
  {
    ...
    odgovor:
      "U svakom tretmanu moguće su modrice, najčešće su male i lako se maskiraju puderom. Otečenost usana moze biti 2-3 dana. Važno je slijediti upute prije i poslije tretmana.",
  },
  {
    pitanje: "Kako djeluje microneedling?",
    odgovor:
      "To je postupak korištenja specijalnog uređaja koji sterilnim ubodima mikroiglicama do 2mm i uz pomoć mezoterapijskih koktela, pomaže stvaranju novog kolagena koji omogućava glađu, čvršću kožu.",
  },
  {
    pitanje: "Hoću li izgledati umjetno nakon aplikacije botoxa ili filere?",
    odgovor:
      "Ne brinite, pravilnom i umjerenom primjenom i s pristupom 'manje je više', pobrinut ćemo se da se to ne dogodi. Nakon naših tretmana pacijenti najčešće dobiju kompliment da izgledaju kao da su se dobro naspavali ili vratili s godišnjeg odmora.",
  },
  {
    pitanje: "Jesu li tretmani bolni?",
    odgovor:
